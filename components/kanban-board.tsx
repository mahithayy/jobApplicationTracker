...
function DroppableColumn({
  ...
  return (
    <Card ref={setNodeRef} className="min-w-[300px] flex-shrink-0 shadow-md p-0">
      <CardHeader
      ...
      >
        <div className="flex items-center justify-between">
          ...
          <DropdownMenu modal={false}>
            ...
            <DropdownMenuTrigger className="h-6 w-6 inline-flex items-center justify-center rounded-md text-white hover:bg-white/20 focus:outline-none">
              <MoreVertical className="h-4 w-4" />
            </DropdownMenuTrigger>
